  ...
  <div id="login">
    ...
    <div class="login-container">
      <div class="login-header logo">
        ...
        <p class="title">大胖电影</p>
        <i class="eng-title">Big Fat Movie</i>
      </div>
      <div class="login-content">
        <div class="login-type">
          <span :class="{ active: loginType }" @click="changeLoginType">用户注册</span>
          <span :class="{ active: !loginType }" @click="changeLoginType">用户登录</span>
        </div>
          ...
          <form>
            ...
            <div v-show="loginType" class="login-phone">
              <section class="login-info">
                ...
                <button v-if="countDown === 0" :class="{ phone_right: checkPhone }" @click.prevent="getValidateCode">
              ...
              <section class="login-info login-verification">
                <input type="tel" placeholder="昵称" v-model="nickName">
              </section>
              <section class="login-info login-verification">
                <input type="tel" placeholder="密码" v-model="password">
              </section>
            ...
            <div v-show="!loginType" class="login-password">
              ...
              <section class="login-info login-verification">
                ...
                <div class="switch-show">
                  <span class="icon-eye-close-fill" v-show="!isShowPassword" @click="changePwdShow">
                  </span>
                  <span class="icon-eye-open-fill" v-show="isShowPassword" @click="changePwdShow">
                  </span>
                </div>
              </section>
              <!-- <section class="login-info">
            ...
            <button v-if="loginType" class="login-submit" @click.prevent="login">
              注册
            </button>
            <button v-else class="login-submit" @click.prevent="login">
              登录
            </button>
          </form>
        </div>
